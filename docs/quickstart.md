...
Install Node 24+ and Python 3 on the publishing machine. Download `direct-ota-0.7.1.tgz` from the [GitHub releases](https://github.com/ibsz909i/direct-ota/releases), then install it in your app:
